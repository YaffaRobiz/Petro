...
export default function AddMaintenanceForm({
  ...
  function handleSubmit(formData: FormData) {
    ...
    startTransition(async () => {
      try {
        await addMaintenanceLog(vehicleId, licensePlate, formData)
  ...
  return (
    <div className="bg-white dark:bg-gray-900 border border-blue-200 dark:border-blue-800 rounded-xl p-5">
      <h3 className="font-semibold text-gray-900 dark:text-white mb-4">New Service Entry</h3>
      ...
      <form ref={formRef} action={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <textarea
            name="notes"
            rows={3}
            className="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100 dark:placeholder-gray-500 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none"
